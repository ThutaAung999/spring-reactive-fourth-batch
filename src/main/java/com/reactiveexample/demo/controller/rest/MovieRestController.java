...
public class MovieRestController {
	...
	//အောက်ကကောင်က  MovieDao  ကို  service layer  ကြားမခံပဲ  တိုက်ရိုက်ခေါ်သုံးထားတာပါ။
	/* @GetMapping("/{id}")	 
...
/*	delete အတွက်  service layer  နဲ့ ရေးဖို့ ကျန်နေသေးတယ်
 * 
@DeleteMapping("/{id}")
...
/* movieDao   ကို တိုက်ရိုက်  ခေါ်ပြီးပဲ ဖျက်ထားတယ်*/
	@DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deleteMovie(@PathVariable(value = "id") String movieId) {
        return movieDao.findById(movieId)
